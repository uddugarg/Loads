...
export default class RiceUnloadForm extends Component {
    ...
    async handleNext() {
        try {
            if (this.state.formData.rice.receivedIn === '') {
                ToastAndroid.show("Select Received In", ToastAndroid.SHORT)
            } else if (this.state.formData.rice.receivedIn === 'Sli Plant' && this.state.formData.rice.sliPlant === '') {
                ToastAndroid.show("Select Plant/Godown", ToastAndroid.SHORT)
            } else if (this.state.formData.rice.receivedIn === 'Sli Godown' && this.state.formData.rice.sliGodown === '') {
                ToastAndroid.show("Select Plant/Godown", ToastAndroid.SHORT)
            } else if (this.state.formData.rice.receivedIn === 'Maharaja Godown' && this.state.formData.rice.maharajaGodown === '') {
                ToastAndroid.show("Select Plant/Godown", ToastAndroid.SHORT)
            } else if (this.state.formData.rice.receivedIn === 'Haudi Katai' && this.state.formData.rice.haudiGodown === '') {
                ToastAndroid.show("Select Plant/Godown", ToastAndroid.SHORT)
